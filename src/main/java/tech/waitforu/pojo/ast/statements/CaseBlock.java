 ...
 * Version 1.0
 */
public class CaseBlock extends AbstractStatement implements Statement {
    ...
    public static class CaseBuilder extends AbstractStatement.StatementBuilder<CaseBuilder> {
