...
public interface krlVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link krlParser#krlControlBlock}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitKrlControlBlock(krlParser.KrlControlBlockContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitMoveStatement(krlParser.MoveStatementContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code primaryExpression} labeled alternative in expression
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrimaryExpression(krlParser.PrimaryExpressionContext ctx);
	/**
	 * Visit a parse tree produced by the {@code orExpression} labeled alternative in expression
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOrExpression(krlParser.OrExpressionContext ctx);
	/**
	 * Visit a parse tree produced by the {@code andExpression} labeled alternative in expression
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAndExpression(krlParser.AndExpressionContext ctx);
	/**
	 * Visit a parse tree produced by the {@code plusMinusExpression} labeled alternative in expression
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPlusMinusExpression(krlParser.PlusMinusExpressionContext ctx);
	/**
	 * Visit a parse tree produced by the {@code multiplyDivideExpression} labeled alternative in expression
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMultiplyDivideExpression(krlParser.MultiplyDivideExpressionContext ctx);
	/**
	 * Visit a parse tree produced by the {@code negOrPosExpression} labeled alternative in expression
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNegOrPosExpression(krlParser.NegOrPosExpressionContext ctx);
	/**
	 * Visit a parse tree produced by the {@code geometryExpression} labeled alternative in expression
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitGeometryExpression(krlParser.GeometryExpressionContext ctx);
	/**
	 * Visit a parse tree produced by the {@code exorExpression} labeled alternative in expression
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExorExpression(krlParser.ExorExpressionContext ctx);
	/**
	 * Visit a parse tree produced by the {@code assignmentExpression} labeled alternative in expression
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssignmentExpression(krlParser.AssignmentExpressionContext ctx);
	/**
	 * Visit a parse tree produced by the {@code notExpression} labeled alternative in expression
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNotExpression(krlParser.NotExpressionContext ctx);
	/**
	 * Visit a parse tree produced by the {@code relationExpression} labeled alternative in expression
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code invokeCallable}
	 * labeled alternative in {@link krlParser#primary}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInvokeCallable(krlParser.InvokeCallableContext ctx);
	/**
